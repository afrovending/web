        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-10">
              <h3 className="text-2xl font-bold mb-6 text-gray-900 border-l-4 border-red-500 pl-4">
                Latest Tutorials
              </h3>
                ...
                {related.map((item) => (
                  ...
                  >
                    <div className="flex gap-4 items-start">
                      ...
                      <div>
                        <h4 className="font-bold text-gray-900 line-clamp-2 group-hover:text-red-600 transition-colors">
                          {item.title}
                        </h4>
              ...
              <div className="mt-10 p-6 bg-red-50 rounded-3xl border border-red-100">
                <p className="text-red-800 font-semibold mb-2">Need Help?</p>
