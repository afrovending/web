      ...
      >
        <div className="space-y-4 pt-2">
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="0.00"
                className="w-full pl-7 pr-4 py-3 border-2 border-gray-100 rounded-xl focus:border-red-500 outline-none text-lg font-semibold transition-colors"
                min={0}
          ...
          <div className="flex flex-col-reverse sm:flex-row justify-end gap-3 mt-6">
            ...
            <button
              className="w-full sm:w-auto px-8 py-3 bg-red-600 text-white font-bold rounded-xl shadow-lg shadow-red-200 hover:bg-red-700 disabled:bg-gray-300 transition-all"
